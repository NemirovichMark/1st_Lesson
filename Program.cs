    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // bb = Double.Parse("Hey, are you ready to errors?");
            ...
            int a0 = 5;
            double S = 13003.0;
            Console.Write("Введите количество(>=2) элементов в ариф., прогрессии :");
            ...
            var d = ((2 * S / n) - 2 * a0) / (n - 1);//также через формулу суммы найдем шаг прогрессии a0-первый член прогрессии
